...
import com.satyamsingh2s.productivity.omega.ui.model.DailyRecordHistoryUiModel
...
@Composable
private fun DailyRecordHistoryScreenPreview() {
    OmegaDarkTheme {
        DailyRecordHistoryScreen(
            historyRecords = listOf(
                DailyRecordHistoryUiModel(
                    recordId = 1,
                    recordDate = LocalDate.of(2026, 6, 13),
                    totalDurationSeconds = 15642,
                    totalSessionCount = 5,
                    totalbreakseconds = 3600
                ),
                DailyRecordHistoryUiModel(
                    recordId = 2,
                    recordDate = LocalDate.of(2026, 6, 12),
                    totalDurationSeconds = 12345,
                    totalSessionCount = 4,
                    totalbreakseconds = 2400
                ),
                DailyRecordHistoryUiModel(
                    recordId = 3,
                    recordDate = LocalDate.of(2026, 6, 11),
                    totalDurationSeconds = 9876,
                    totalSessionCount = 3,
